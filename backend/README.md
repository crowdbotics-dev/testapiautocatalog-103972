...
## Project Structure
    ...
    ├── testapiautocatalog_103972  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_103972`
...
2. Clone this repo and `cd testapiautocatalog_103972`
